...
PAGES = [
        ...
        "content": "\n".join(
            [
                section_from_paragraphs([
                    ...
                    "Hébergement : Vercel Inc., 440 N Barranca Ave #4133, Covina, CA 91723, Ã‰tats-Unis.",
    ...
    {
        "slug": "a-propos",
        "title": "Ã€ propos de Déménagement Zen",
        ...
        "content": section_from_paragraphs([
            ...
            "Nous plaçons la qualité de service et la transparence au cÅ“ur de chaque mission.",
        ]),
    },
    {
        "slug": "cgu",
